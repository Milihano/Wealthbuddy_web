                ...
                <body className="font-Montserrat">
                    ...
                    <div className="w-[500px] h-[] top-[2200px] left-[150px] absolute">
                        <div className="absolute top-[50px] left-[50px]">                                
                            ...
                            <label htmlFor="" id="dis">I agree to the terms & conditions of this application</label>
                        </div>                                               
                    </div>
                    ...
                    <div className="absolute w-[600px] h-[400px] top-[800px] left-[300px] z-20 border rounded-lg bg-[white] ">
                        <div className="absolute w-[30px] top-[20px] left-[280px]">
                            <AiFillCheckCircle/>
                        </div>
                        <div className="absolute w-[30px] top-[50px] left-[250px]">
                            <p>Awesome</p>
                        </div> 
                        <div className="absolute w-[498px] h-[121px] top-[100px] left-[40px] text-center">
                            <p>
                                We will keep you posted via your
                                email address so you can track the
                                progress of your delivery.
                            </p>
                        </div>   
                        <div className="absolute left-[200px] top-[200px] sm:absolute sm:left-[121px] sm:top-[2570px]">
                            <a href="/">
                                <button className="flex border w-[200px] h-[40px] items-center justify-center bg-[red] rounded sm:w-[185px] sm:h-[37px]">
                                    <p className="mr-[0.4rem] text-[#ffffff]">BACK HOME</p>
                                    <div className="text-[#ffffff]">
                                        <BsFillArrowRightCircleFill/>
                                    </div>                                
                                </button>
